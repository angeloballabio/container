...
<ul class="d-flex justify-content-start">
    ...
    @else
    <li class="w-20 px-2 py-1 text-center rounded border shadow cursor-pointer" style="list-style-type:none;"  wire:click="previousPage" >@lang('pagination.previous')</li>
    @endif
    <!-- prev end -->
