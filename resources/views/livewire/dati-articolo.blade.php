<div class="row">
   ...
   <div class="col-4">
    ...
    <div class="col-6 shadow p-2 mb-2 bg-white rounded">
        ...
        <div class="col-4 float-left">
            <input type="checkbox"  style="height: 20px" id="carta" value="true" {{-- {{ $operazione->richiede_sanitari }} ? checked : '' --}}> <label for="acciaio" style="height: 20px">Articoli pasta carta</label>
        </div>
        <div class="col-4 float-left">
            <input type="checkbox"  style="height: 20px" id="pietra" value="true" {{-- {{ $operazione->richiede_sanitari }} ? checked : '' --}}> <label for="acciaio" style="height: 20px">Articoli in pietra</label>
        </div>
   </div>
   <div class="col-6 shadow p-2 mb-2 bg-white rounded">
        <div class="col-4 float-left">
            <input type="checkbox"  style="height: 20px" id="ce" value="true" {{-- {{ $operazione->richiede_sanitari }} ? checked : '' --}}> <label for="acciaio" style="height: 20px">Richiede CE</label>
        </div>
        <div class="col-4 float-left">
            <input type="checkbox"  style="height: 20px" id="age" value="true" {{-- {{ $operazione->richiede_sanitari }} ? checked : '' --}}> <label for="acciaio" style="height: 20px">Riciede AGE</label>
        </div>
        <div class="col-4 float-left">
            <input type="checkbox"  style="height: 20px" id="cites" value="true" {{-- {{ $operazione->richiede_sanitari }} ? checked : '' --}}> <label for="acciaio" style="height: 20px">Richiede CITES</label>
        </div>
        <div class="col-4 float-left">
