    ...
    <table  style="width: 100%; border-collapse: collapse; border: 1px solid black; ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="border-collapse: collapse; border: 1px solid black; background-color: #6699ff; color: white;" wire:click="$emit('OrdineSelezionato',{{ $operazione->id }})">{{ $operazione->data_arrivo_nave }}</td>
